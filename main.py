...
print(f"shallow_mnistNIST: TEST {final_report['shallow_mnist']}")

final_report["shallow_cifar10"] = shallow_nn_training("CIFAR10")
print(f"shallow_cifar10: TEST {final_report['shallow_cifar10']}")

final_report["medium_mnist"] = medium_nn_training("MNIST")
print(f"medium_mnist: TEST {final_report['medium_mnist']}")

final_report["medium_cifar10"] = medium_nn_training("CIFAR10")
print(f"medium_cifar10: TEST {final_report['medium_cifar10']}")

final_report["deep_mnist"] = deep_nn_training("MNIST")
print(f"deep_mnist: TEST {final_report['deep_mnist']}")

final_report["deep_cifar10"] = deep_nn_training("CIFAR10")
print(f"deep_cifar10: TEST {final_report['deep_cifar10']}")
